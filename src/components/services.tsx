  ...
  const services = [
    {
      ...
      description: "Creación de servicios backend robustos y escalables con Java, Kotlin, C#, .NET, Python y PHP",
      icon: (
        <svg
          width="40"
          height="40"
    ...
    },
    {
      ...
      description: "Desarrollo de aplicaciones móviles nativas para Android con Kotlin y multiplataforma con Flutter",
      icon: (
        <svg
          width="40"
          height="40"
    ...
    },
    {
      id: 3,
      title: "Full Stack",
      description: "Soluciones completas desde el backend hasta el frontend, optimizadas y escalables con tecnologías modernas",
      icon: (
        <svg
          width="40"
          height="40"
