...
export function Header() {
  ...
  return (
    <header className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-4xl transition-all duration-1000 ${
      ...
      <nav className="bg-white/95 backdrop-blur-md rounded-full shadow-xl border border-gray-100 px-2 py-2 sm:px-4 sm:py-3 flex items-center justify-between sm:justify-center sm:gap-2">
        <div className="flex items-center gap-2 px-2 sm:px-4">
          <img src="/logo.png" alt="Mario AJ" className="h-8 w-8 sm:h-10 sm:w-10 rounded-full object-cover" />
        </div>
